...
const UserAvatar = ({ size = 36, avatarUrl, name, username }: { size?: number; avatarUrl?: string; name?: string; username?: string }) =>
  avatarUrl ? (
    <Image
...
const ProfileDropdown = ({ user, onMenuClick, onLogout }: { user: { name: string; username: string }; onMenuClick: () => void; onLogout: () => void }) => {
  return (
    <div
            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="relative" ref={profileMenuRef}>
                  ...
                  >
                    <UserAvatar avatarUrl={user.avatarUrl} name={user.name} username={user.username} />
